...
const mensajes = {
	mexico: 'El usuario es mexicano',
	colombia: 'El usuario es colombiano',
	españa: 'El usuario es español',
};

console.log(mensajes[usuario.pais] || 'El usuario es de otro pais');
